...
* add .env.sample ([c84325a](https://github.com/yawn-test-org-2/decidim-cfj/commit/c84325a5116ec4db5bbbb3c7c2abb96e4b6c8c0b))
* add LINE as SNS ([b587977](https://github.com/yawn-test-org-2/decidim-cfj/commit/b587977137b04ee629684abd269d8d53e5c707e7))
* add rake task `i18n_yaml:dump_all` ([de9701b](https://github.com/yawn-test-org-2/decidim-cfj/commit/de9701b47a962af4282e94466f543260b09069cf))
* add settings for components ([730e19c](https://github.com/yawn-test-org-2/decidim-cfj/commit/730e19ce1225f7ba6549ea3f4844c7526d1da8fd))
* change imagemagick binary ([faae0a4](https://github.com/yawn-test-org-2/decidim-cfj/commit/faae0a4e494f5950c006804d51a590c12d8e989a))
* disable other actions ([4f2dfc4](https://github.com/yawn-test-org-2/decidim-cfj/commit/4f2dfc4c6329124099bf76a1738dd991df8d5783))
* hide parts if settings is disabled ([b36a93d](https://github.com/yawn-test-org-2/decidim-cfj/commit/b36a93d411d156f90938cf2ac20fccdc03259d06))
* OmniAuth::Logging and subscribe hook ([d764a07](https://github.com/yawn-test-org-2/decidim-cfj/commit/d764a07b2e67466cf30b50b25026f92d32d9411c))
* skip specs; and all comments should be in English ([1f0587a](https://github.com/yawn-test-org-2/decidim-cfj/commit/1f0587a131fdedafd10b88aa134bfcf718de6727))
* update decidim 0.28.4 ([982bc86](https://github.com/yawn-test-org-2/decidim-cfj/commit/982bc86c8a4b8017a7e73aecca7ec3b8a2c63140))
* update decidim v 0.28.1 ([d2f3792](https://github.com/yawn-test-org-2/decidim-cfj/commit/d2f379283ea730dd02d978d0c871f0c84ef58bd8))
* update decidim v0.27.9 ([6cdfdee](https://github.com/yawn-test-org-2/decidim-cfj/commit/6cdfdee7aea10154d72b355337bc3085f935a3d9))
* update decidim v0.28.5 ([2ad9a75](https://github.com/yawn-test-org-2/decidim-cfj/commit/2ad9a7533888504dd3dd0212b21c8a435a348c9d))
* update decidim v0.29.2 ([d341e6d](https://github.com/yawn-test-org-2/decidim-cfj/commit/d341e6dd25b09e84bd890e101dcde9b5ad076c74))
* update decidim-awesome ([4f679cf](https://github.com/yawn-test-org-2/decidim-cfj/commit/4f679cfc526cb0003c062e8cc2e3869fec3af77e))
* update destroy organization ([9119ff7](https://github.com/yawn-test-org-2/decidim-cfj/commit/9119ff7416f1ec89463b78354a05323d0479b05a))
* update github workflow ([f990e45](https://github.com/yawn-test-org-2/decidim-cfj/commit/f990e45ea4e6f16582de3fdd26c6676d101e148f))


### Bug Fixes

* `hello` with name ([0548566](https://github.com/yawn-test-org-2/decidim-cfj/commit/0548566058f2660fe6df5929248379b64b462ca7))
* `process_types` ([67df526](https://github.com/yawn-test-org-2/decidim-cfj/commit/67df526eb375902094f002a6b6a8f6baeb5df29b))
* add chromium-driver ([a207b4d](https://github.com/yawn-test-org-2/decidim-cfj/commit/a207b4d3cbf9eb696eb400320e3ddfaa972824c6))
* add footer_topics in footer ([b17e50f](https://github.com/yawn-test-org-2/decidim-cfj/commit/b17e50fbddb706f80462d4723ed34615b84ffb5c))
* add locale data ([ece5d10](https://github.com/yawn-test-org-2/decidim-cfj/commit/ece5d10c457a657a3f293ff5719cad41d3f25dc2))
* add locales in EN ([2c828bd](https://github.com/yawn-test-org-2/decidim-cfj/commit/2c828bd6206fd6721e72443ffb44a1be189f1564))
* add platform ([7679d73](https://github.com/yawn-test-org-2/decidim-cfj/commit/7679d73de0e15262ee2164f0268c1d572ea262eb))
* Add translation for following count ([f8ef737](https://github.com/yawn-test-org-2/decidim-cfj/commit/f8ef7373881fe188d86bb5ecfa1ed1f5eb9adb4c))
* add translations ([28d6371](https://github.com/yawn-test-org-2/decidim-cfj/commit/28d63715001bc1927486d3929162298f679e23b5))
* address help ([fb05693](https://github.com/yawn-test-org-2/decidim-cfj/commit/fb05693442ce8e31027e3f0972ea6a598991dc0d))
* allow to use search with pg_bigm ([698e93e](https://github.com/yawn-test-org-2/decidim-cfj/commit/698e93e7e0c39c2bd63d8d5852b8b9df5cad2f76))
* apply 0.28.5 update for mailer ([e00c3db](https://github.com/yawn-test-org-2/decidim-cfj/commit/e00c3db19eaac1d2b28ec7eb1eee7fe91958133e))
* blob path to url ([4b41fad](https://github.com/yawn-test-org-2/decidim-cfj/commit/4b41fadcb91f52f99fee8447a486f6b6782281e9))
* change expire ([12f49aa](https://github.com/yawn-test-org-2/decidim-cfj/commit/12f49aa790644db65fbef18a549bb3f0e908be9b))
* content_type not found error ([d673b3b](https://github.com/yawn-test-org-2/decidim-cfj/commit/d673b3b7d757e3e7de67fca2ea8d7283c58a9818))
* decidim.endorsement_buttons_cell.endorse ([fee2a70](https://github.com/yawn-test-org-2/decidim-cfj/commit/fee2a70979b0aed3d3020dbaf1949fc9bbef84d4))
* default_locale should be `ja` ([6a8c8a8](https://github.com/yawn-test-org-2/decidim-cfj/commit/6a8c8a8dd6530babc372ba8806f5bc29de7e3d4a))
* disable external link ([3bd6b46](https://github.com/yawn-test-org-2/decidim-cfj/commit/3bd6b46467f40097195262f54d92a02489695ccf))
* disable message functionality in profile actions via patch ([8b4dc8f](https://github.com/yawn-test-org-2/decidim-cfj/commit/8b4dc8fb241b5285e781f7f4a76c2b711d06aa3d))
* do not add comment_counts if already registered ([cf6a568](https://github.com/yawn-test-org-2/decidim-cfj/commit/cf6a5686b93f2e1c64c46dc1d654579a99167b2d))
* do not define names of organization ([892b992](https://github.com/yawn-test-org-2/decidim-cfj/commit/892b992233829973035323098a06118c1d4c1f85))
* do not show process_types in other organizations ([5662638](https://github.com/yawn-test-org-2/decidim-cfj/commit/56626381cb88420fd43ba5412d2924d258fb090d))
* drop bot request ([51d6d51](https://github.com/yawn-test-org-2/decidim-cfj/commit/51d6d51555cda68430245872ee5e312335da7cac))
* drop gptbot access ([b0504db](https://github.com/yawn-test-org-2/decidim-cfj/commit/b0504dba9a6bb378b257a1ba2f02760bd85e87d2))
* editor_image permissions for process admin ([74d3dbc](https://github.com/yawn-test-org-2/decidim-cfj/commit/74d3dbcf0a15c0f7e23dfbb446b849c2f1317757))
* error ([85bb24d](https://github.com/yawn-test-org-2/decidim-cfj/commit/85bb24da21f8392e039c6c8ab7a5fbfe8b9d4cc5))
* GA: remove unused envvar ([cf2f484](https://github.com/yawn-test-org-2/decidim-cfj/commit/cf2f484d15eaab658dafb8a9090dcf3e749059c4))
* gem version ([2da0587](https://github.com/yawn-test-org-2/decidim-cfj/commit/2da05875f0e05093286168683af5223f2049548f))
* Hide filter if only a single TreePoint node is present ([b01c7bd](https://github.com/yawn-test-org-2/decidim-cfj/commit/b01c7bd629d75aed62dac6b1a901362c8170d3ce))
* iframe extension ([ad0bc90](https://github.com/yawn-test-org-2/decidim-cfj/commit/ad0bc90df36bd60df18690ed9255c9a3b77a4c6e))
* iframe: allow any domains ([78054c5](https://github.com/yawn-test-org-2/decidim-cfj/commit/78054c51f3175094e8d9458b9f5ce06c81a5f736))
* ignore files in node_modeles ([e74e579](https://github.com/yawn-test-org-2/decidim-cfj/commit/e74e579d5459d19d52e4196fbb2bdc552c059708))
* ignore session_store defined in Decidim::Core::Engine ([52a14e8](https://github.com/yawn-test-org-2/decidim-cfj/commit/52a14e80bccf1763ff67c88c553a2764afd722f7))
* initializer ([d218cdf](https://github.com/yawn-test-org-2/decidim-cfj/commit/d218cdf27899139d90c64e845c80018899043d59))
* link to last comments ([7e0b18c](https://github.com/yawn-test-org-2/decidim-cfj/commit/7e0b18c8c9edd7587bc0f42cd69fc9f471966eec))
* lint ([dd28f3e](https://github.com/yawn-test-org-2/decidim-cfj/commit/dd28f3eeff410841c2ed0eb7c87ccd0051ed5331))
* lint ([47d9880](https://github.com/yawn-test-org-2/decidim-cfj/commit/47d9880becec44d93056e3f4fc3c8fd1542d43a6))
* lint ([1fc7c63](https://github.com/yawn-test-org-2/decidim-cfj/commit/1fc7c6348c708e1a0c3530df079928e504e18a41))
* local docker postgres ([287786f](https://github.com/yawn-test-org-2/decidim-cfj/commit/287786f30ab050c9fd32ade9d4e31f8795e4bd16))
* locale for devise and user_extension ([09c0c32](https://github.com/yawn-test-org-2/decidim-cfj/commit/09c0c327c495f262747685a87c1e24d919cbbc15))
* mail logo bug ([676e0b4](https://github.com/yawn-test-org-2/decidim-cfj/commit/676e0b46b429a8dbb20d56d0fc172879f9df64db))
* mail logo url ([05a2e6a](https://github.com/yawn-test-org-2/decidim-cfj/commit/05a2e6ad58031fa8c746127a96d5af75863c5b5c))
* mail template ([6b26ee7](https://github.com/yawn-test-org-2/decidim-cfj/commit/6b26ee75064574003c5096537331cab2dc6046f7))
* make announcement content_block as default ([78265ec](https://github.com/yawn-test-org-2/decidim-cfj/commit/78265ec2a775e4e5b3be395f94b872a82155a0b9))
* make auto_save_forms disable ([cc82360](https://github.com/yawn-test-org-2/decidim-cfj/commit/cc82360f8fb9cf060dac1b80f1fe2001c906d585))
* make comments_count 3 ([45665e6](https://github.com/yawn-test-org-2/decidim-cfj/commit/45665e65cc5cc9a0fcc7a14b721342a1b310b4ed))
* make use_cookies_with_metadata true (same as default) ([d52eaea](https://github.com/yawn-test-org-2/decidim-cfj/commit/d52eaea57ea855c005d61ad3ecd339753f2e06ef))
* MapHelper#awesome_map_for returns valid map_center ([b22c400](https://github.com/yawn-test-org-2/decidim-cfj/commit/b22c400e810febd1d08cbc1481ff3df2cdb7d5b3))
* max length of description should be defined in a constant ([50189e6](https://github.com/yawn-test-org-2/decidim-cfj/commit/50189e6c6208f1010bf57660daa5f36ff7c6e6df))
* old locales data ([8f0348a](https://github.com/yawn-test-org-2/decidim-cfj/commit/8f0348a53e047259ee33c06efc60c79e6f2db595))
* override BlobParser instead of copying forms ([021bc63](https://github.com/yawn-test-org-2/decidim-cfj/commit/021bc63283d98d51a955582d2b5ccb35ab4ccd47))
* override CSP settings in all specs ([1e6869f](https://github.com/yawn-test-org-2/decidim-cfj/commit/1e6869fe1fa84fbd4c4e37df80ff5c33c1a369d2))
* override links controller escape_url ([de52eb1](https://github.com/yawn-test-org-2/decidim-cfj/commit/de52eb1b7eca6a2d6c1271014d03bd407fac76aa))
* placeholder for name and email ([b8fdcc4](https://github.com/yawn-test-org-2/decidim-cfj/commit/b8fdcc47fc892cf54bb3dffee3fd03a09d2f94b0))
* Prevent error when `model.proposal_state` is nil ([97b261f](https://github.com/yawn-test-org-2/decidim-cfj/commit/97b261f7bd5441e69dbb4eb00318c7900461db91))
* ProposalState model with token generation bug fix ([c90528b](https://github.com/yawn-test-org-2/decidim-cfj/commit/c90528ba954556623553b320743c2dc531ce2534))
* refactor fix conflict migrations ([18778e7](https://github.com/yawn-test-org-2/decidim-cfj/commit/18778e7cae0ff559bd1f966c622b42641546f5b5))
* refactor session ([0b81968](https://github.com/yawn-test-org-2/decidim-cfj/commit/0b81968e84e0f83366f43426cdd85b8d80b301d5))
* refactor update lint ([892fe95](https://github.com/yawn-test-org-2/decidim-cfj/commit/892fe9563634202d3d244df98625d8a1aa003b3b))
* remove `urlsafe_csrf_tokens` ([22c09bb](https://github.com/yawn-test-org-2/decidim-cfj/commit/22c09bbc41047cafe5b78298163636cab6e71428))
* remove aria attribute as v0.29.2 ([ee839bd](https://github.com/yawn-test-org-2/decidim-cfj/commit/ee839bd0039458c56dfb0f5e175f6124028b5dd8))
* remove Decidim::Amendable::AmendButtonCardCell ([1097032](https://github.com/yawn-test-org-2/decidim-cfj/commit/1097032a31e1974eb9e083e4a0aa9105578cfcc0))
* remove decidim.scss and settings.scss ([141b166](https://github.com/yawn-test-org-2/decidim-cfj/commit/141b166b52f1b48c9bab3591dd58c9b4ad1704d6))
* remove hack to skip session_store ([55d6715](https://github.com/yawn-test-org-2/decidim-cfj/commit/55d67150b570e83ed297016306f8b19c04a44764))
* remove installed gem ([aae2dac](https://github.com/yawn-test-org-2/decidim-cfj/commit/aae2dac59a50c868e07f1f40ecf75a34fc2eb767))
* remove invalid characters in file_type ([6ee63df](https://github.com/yawn-test-org-2/decidim-cfj/commit/6ee63df691f5cff61bd760ea078e59b96773dc94))
* remove old styles ([504c55b](https://github.com/yawn-test-org-2/decidim-cfj/commit/504c55b5392b33d9b02af42f6af10635484e9f1b))
* remove unused packages ([356366a](https://github.com/yawn-test-org-2/decidim-cfj/commit/356366a5c100071579c1132846387b578a25f15f))
* remove uploader override ([00cec19](https://github.com/yawn-test-org-2/decidim-cfj/commit/00cec199f639263f35d81e5e0203e5e83a315a86))
* revert [#69](https://github.com/yawn-test-org-2/decidim-cfj/issues/69) ([89512ac](https://github.com/yawn-test-org-2/decidim-cfj/commit/89512acd05cf7662559e64ea31c0a3f246f1338b))
* rubocop ([1a9e6bd](https://github.com/yawn-test-org-2/decidim-cfj/commit/1a9e6bdcb9fd2f9dd1f27d2cfab07ca0049bac8e))
* rubocop ([07f18ce](https://github.com/yawn-test-org-2/decidim-cfj/commit/07f18ce9243d50c1d7b2cf64a454db8a78059a9f))
* show only visible processes ([687b97f](https://github.com/yawn-test-org-2/decidim-cfj/commit/687b97f1a20af8ea6867406873af021d1339c74e))
* spec ([86136d4](https://github.com/yawn-test-org-2/decidim-cfj/commit/86136d448180968223974b73ba1694df31d4bb28))
* static provider path ([ca81975](https://github.com/yawn-test-org-2/decidim-cfj/commit/ca81975f0c708466e9ca5d28b3257ea9a3cbc164))
* suppress warnings in iframe ([e14a309](https://github.com/yawn-test-org-2/decidim-cfj/commit/e14a309f1ace1a321c33a7f4b268fa45823934aa))
* Suppress warnings in server ([8a532d8](https://github.com/yawn-test-org-2/decidim-cfj/commit/8a532d8b8c0178a9fd76f76b140328dd539c11f0))
* Suppress warnings in server ([d32189e](https://github.com/yawn-test-org-2/decidim-cfj/commit/d32189ec83aa68d9084c3442a9de13c36f0d18cc))
* Suppress warnings in server ([bfc1774](https://github.com/yawn-test-org-2/decidim-cfj/commit/bfc177436865ef2e6d42a1a569dbb9f4041faa53))
* update app/views/decidim/application/_document.html.erb to v0.29.2 ([6710344](https://github.com/yawn-test-org-2/decidim-cfj/commit/6710344d80e0fdaa4bf1fb0392e54440854d97fc))
* update app/views/layouts/decidim/_mailer_logo.html.erb ([7d3072b](https://github.com/yawn-test-org-2/decidim-cfj/commit/7d3072b915fa848d17860d0a8e12bea77f9c8d5e))
* update app/views/layouts/decidim/mailer.html.erb ([1cb9da6](https://github.com/yawn-test-org-2/decidim-cfj/commit/1cb9da6d5c567e5655a48c430c3904086f52edd0))
* update Decidim v0.27.7 ([fdb0a31](https://github.com/yawn-test-org-2/decidim-cfj/commit/fdb0a31250b1a064ba8e8c7d0ca7c3a87d1c74d1))
* update decidim-module-decidim_awesome ([0f66711](https://github.com/yawn-test-org-2/decidim-cfj/commit/0f667116cfc53be1692f1746d567c563f82079e2))
* update load_defaults to 6.0 ([028e89a](https://github.com/yawn-test-org-2/decidim-cfj/commit/028e89a7ab11eba388245f747608708742796cbb))
* update load_defaults to 6.1 ([d0af6fa](https://github.com/yawn-test-org-2/decidim-cfj/commit/d0af6faa6d0ac68dbeb258fff427554a2a1f3308))
* update lock file ([8f203a2](https://github.com/yawn-test-org-2/decidim-cfj/commit/8f203a2efdf5dc706284b5205d97a648ffb6bccb))
* update lock file ([5429507](https://github.com/yawn-test-org-2/decidim-cfj/commit/5429507de653e60147fdb9121ecbb331f2779865))
* update max_results in highlighted settings ([3215f28](https://github.com/yawn-test-org-2/decidim-cfj/commit/3215f28f5d9e5ad356cb9b73b04bcc2e68d0b4de))
* update participatory_processes/show.html.erb to v0.29.2 ([f5f4ea7](https://github.com/yawn-test-org-2/decidim-cfj/commit/f5f4ea7af8508000deef7379fc420921855cc086))
* upload images in rich editor ([dc1fa75](https://github.com/yawn-test-org-2/decidim-cfj/commit/dc1fa7525e7370257f4c6b58f51d160644a31e36))
* urls_expire_in to nil ([78b625e](https://github.com/yawn-test-org-2/decidim-cfj/commit/78b625e7b56321300902273ebe1a8e3d10147afa))
* use `decidim_sanitize_admin` instead of `decidim_escape_translated` ([863bcb7](https://github.com/yawn-test-org-2/decidim-cfj/commit/863bcb756cf9cc4ad9139b84662df8efeb69b28e))
* Use expire_session_after for session, REDIS_CACHE_EXPIRES_IN for cache ([7f5eb63](https://github.com/yawn-test-org-2/decidim-cfj/commit/7f5eb63188ff1956b99ccb8fa0c8ffa4af2eb770))
* use mail default template ([d23a167](https://github.com/yawn-test-org-2/decidim-cfj/commit/d23a167cffdba937a5c1c7d3ec7c1a170fbdfde3))
* Use Redis with docker compose ([a97e0ed](https://github.com/yawn-test-org-2/decidim-cfj/commit/a97e0ed328246933bb8e98f863d350b1bc7e1959))
* user registration ([e13eef7](https://github.com/yawn-test-org-2/decidim-cfj/commit/e13eef73bc1fb0fab9fec72a71f7a361524f490c))
...
* remove mimemagic ([e2baeaf](https://github.com/codeforjapan/decidim-cfj/commit/e2baeaf0b4ee03bbaf13beb3c9402f3dd389b300))
